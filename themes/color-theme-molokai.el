...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (font-lock-comment-face ((t (:foreground "#465457" :Menlo))))
     (font-lock-comment-delimiter-face ((t (:foreground "#465457" :Menlo))))
     (font-lock-constant-face ((t (:foreground "#AE81FF"))))
     (font-lock-doc-face ((t (:foreground "#E6DB74" :Menlo))))
     (font-lock-function-name-face ((t (:foreground "#F92672" :Menlo))))
