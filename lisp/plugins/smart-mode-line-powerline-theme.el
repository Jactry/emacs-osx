...
(let ((l0 "black")
  ...
  (custom-theme-set-faces
   ...
   ;; Layer 0
   `(sml/line-number         ((t :foreground "White" :inherit sml/global :weight bold :background "DodgerBlue")))
   `(sml/remote              ((t :inherit sml/global :background ,l0)))
   `(sml/col-number          ((t :inherit sml/global :background "LightSkyBlue")))
   `(sml/numbers-separator   ((t :inherit sml/col-number :background "LightSkyBlue")))
   ...
   `(sml/filename  ((t :background ,l3 :inherit sml/global :foreground "SteelBlue")))
